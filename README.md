...
| See which service uses which database, cache, or queue (AWS) | `/scoutflo:map-topology` — Cloud Mode proposes evidence-backed connections; you confirm them in one batch |
