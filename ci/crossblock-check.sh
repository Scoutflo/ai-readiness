...
EXTERNAL="HOME PWD USER SHELL PATH TMPDIR TMP CLAUDE_PLUGIN_ROOT SCOUTFLO_AUDIT_DIR SCOUTFLO_CONFIG SCOUTFLO_SLACK_WEBHOOK PROM_TOKEN GRAFANA_TOKEN SENTRY_TOKEN DATADOG_API_KEY DATADOG_APP_KEY KIBANA_API_KEY PAGERDUTY_TOKEN ZENDUTY_TOKEN GROUNDCOVER_API_KEY DIGITALOCEAN_ACCESS_TOKEN DO_TOKEN JSM_API_TOKEN JSM_EMAIL JSM_CLOUD_ID VM_TOKEN LOKI_TOKEN TEMPO_TOKEN MIMIR_TOKEN ANTHROPIC_API_KEY AWS_ROLE_ARN GOOGLE_APPLICATION_CREDENTIALS OUT_DIR CURL_MAX_TIME SLACK_WEBHOOK_URL IFS REPLY LINENO RANDOM SECONDS PIPESTATUS OPTARG OPTIND LANG LC_ALL TERM COLUMNS"
