...
| --- | --- | --- | --- | --- |
| Grafana | audit-grafana, setup-grafana, audit-lgtm, audit-alertmanager | `grafana:` | `GRAFANA_TOKEN` | Viewer for audits; Editor or Admin for setup |
...
| Prometheus + Alertmanager | audit-prometheus, audit-lgtm, setup-lgtm, audit-alertmanager | `prometheus:` | `PROM_TOKEN` (only if your endpoints require auth) | URL reachability; optional bearer |
